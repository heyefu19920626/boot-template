!function (window) {
    ...
    CanvasRenderingContext2D.prototype.JTopoRoundRect = function (a, b, c, d, e) {
        ...
        MouseCursor: {
            ...
            move: "move",
            open_hand: "url(/img/jtopo/openhand.cur) 8 8, default",
            closed_hand: "url(/img/jtopo/closedhand.cur) 8 8, default"
        },
    ...
    function changeColor(a, b, c) {
        var d = c.split(","), e = parseInt(d[0]), f = parseInt(d[1]), g = parseInt(d[2]), h = canvas.width = b.width,
